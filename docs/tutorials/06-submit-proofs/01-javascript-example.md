...
Run the script by providing 2 arguments: `proof type` and `proof`.  You should see the transaction successfully finalized and a NewAttestationEvent emitted.

```shell
node submitProof.js <proofType> <proof>
```
